  ...
  return (
    <div className="single__project">
      ...
      <motion.div className="github__div" initial={{opacity:0}} animate={{opacity:1}} transition={{delay:2.5,...transition}}>
       ...
       <a href="https://github.com/DaniilBabakin/OpticaVzorSite" rel="noreferrer" target="_blank" className="github__link"><img src={require("../assets/Github.png")} alt="GitHub" className="github__icon"/><span className="github__span">Project on GitHub</span></a>

       <a href="https://opticavzor.ru" rel="noreferrer" target="_blank" className="github__link"><img src={require("../assets/link.png")} alt="Link on project" className="github__icon"/><span className="github__span link">Project Link</span></a>
